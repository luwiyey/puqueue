...
export function StaffFinanceSidebar() {
  return (
    <Sidebar>
      <SidebarHeader>
        <Link href="/staff-finance-dashboard" className="flex items-center gap-2">
      ...
      <SidebarMenu className="flex-1 overflow-auto p-2">
        <SidebarGroup>
            <SidebarGroupLabel>Finance Menu</SidebarGroupLabel>
