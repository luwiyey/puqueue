...
export function StaffLegalOfficeSidebar() {
  return (
    <Sidebar>
      <SidebarHeader>
        <Link href="/staff-legaloffice-dashboard" className="flex items-center gap-2">
      ...
      <SidebarMenu className="flex-1 overflow-auto p-2">
        <SidebarGroup>
            <SidebarGroupLabel>Legal Office Menu</SidebarGroupLabel>
