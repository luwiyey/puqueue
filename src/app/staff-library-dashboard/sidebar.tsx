...
export function StaffLibrarySidebar() {
  return (
    <Sidebar>
      <SidebarHeader>
        <Link href="/staff-library-dashboard" className="flex items-center gap-2">
      ...
      <SidebarMenu className="flex-1 overflow-auto p-2">
        <SidebarGroup>
            <SidebarGroupLabel>Library Menu</SidebarGroupLabel>
